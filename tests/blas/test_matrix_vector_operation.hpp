...
TEST(MatrixVectorOperation, CalculateSymmetricMatrixVectorProductType1Specific) {
   ...
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(&out_p3, 2.3, mat_p3, vec_p3, &work_p3),
                std::runtime_error);
#else
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(&out_p3, 2.3, mat_p3, vec_p3),
                std::runtime_error);
#endif
   ...
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(&out_p4, 2.3, mat_p4, vec_p4, &work_p4),
                std::runtime_error);
#else
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(&out_p4, 2.3, mat_p4, vec_p4),
                std::runtime_error);
#endif
...
#ifdef _OPENMP
   std::vector<std::vector<double>> work_p3(omp_get_max_threads(), std::vector<double>(3));
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(2.3, mat_p3, vec_p3, &work_p3),
                std::runtime_error);
#else
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(2.3, mat_p3, vec_p3),
                std::runtime_error);
#endif
...
#ifdef _OPENMP
   std::vector<std::vector<double>> work_p4(omp_get_max_threads(), std::vector<double>(3));
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(2.3, mat_p4, vec_p4, &work_p4),
                std::runtime_error);
#else
   EXPECT_THROW(blas::CalculateSymmetricMatrixVectorProduct(2.3, mat_p4, vec_p4),
                std::runtime_error);
#endif
