...
#pragma omp parallel for reduction (+: residual_error)
      for (std::int64_t i = 0; i < dim; ++i) {
         r.value_list[i] = k_e_vec[0]*w0.value_list[i] + k_e_vec[1]*w1.value_list[i] + k_e_vec[2]*w2.value_list[i]
         - k_e_val[0]*(k_e_vec[0]*v0.value_list[i] + k_e_vec[1]*v1.value_list[i] + k_e_vec[2]*v2.value_list[i]);
...
#pragma omp parallel for
      for (std::int64_t i = 0; i < dim; ++i) {
         v0.value_list[i] = k_e_vec[0]*v0.value_list[i] + k_e_vec[1]*v1.value_list[i] + k_e_vec[2]*v2.value_list[i];
...
#pragma omp parallel for
      for (std::int64_t i = 0; i < dim; ++i) {
         w0.value_list[i] = alpha*(k_e_vec[0]*w0.value_list[i] + k_e_vec[1]*w1.value_list[i] + k_e_vec[2]*w2.value_list[i]);
