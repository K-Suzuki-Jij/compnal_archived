...
class GeneralModel : public BaseClass {
  ...
  public:
   ...
   using IntersiteListType =
       std::unordered_map<IndexType, std::unordered_map<IndexType, std::vector<std::pair<CRS, CRS>>, IndexHash>,
                          IndexHash>;
   ...
   void AddInteraction(const IndexType &site_1, const CRS &m_1, const IndexType &site_2, const CRS &m_2,
   ...
   int GetSystemSize() const { return static_cast<int>(index_list_.size()); }

   //! @brief Get the site index list.
   //! @return The site index list.
   const std::unordered_set<IndexType, IndexHash> &GetIndexSet() const { return index_list_; }
   ...
   inline const std::vector<std::pair<CRS, CRS>> &GetInteraction(const IndexType &site_1,
                                                                 const IndexType &site_2) const {
