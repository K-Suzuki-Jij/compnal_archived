...
public:
   ...
   XXZ_1D(const int system_size, const utility::HalfInt magnitude_spin): BaseU1Spin_1D<RealType>(system_size, magnitude_spin) {
      onsite_operator_ham_ = CreateOnsiteOperatorHam(0.5*this->magnitude_2spin_, h_z_, D_z_);
   }
   ...
   //! @param magnitude_spin The magnitude of the spin \f$ S \f$.
   //! @param boundary_condition Boundary condition.
   XXZ_1D(const int system_size, const utility::HalfInt magnitude_spin, const utility::BoundaryCondition boundary_condition): BaseU1Spin_1D<RealType>(system_size, magnitude_spin) {
      SetBoundaryCondition(boundary_condition);
      onsite_operator_ham_ = CreateOnsiteOperatorHam(0.5*this->magnitude_2spin_, h_z_, D_z_);
   }
   ...
   static CRS CreateOnsiteOperatorHam(const utility::HalfInt magnitude_spin, const RealType h_z = 0.0, const RealType D_z = 0.0) {
