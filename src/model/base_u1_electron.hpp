...
class BaseU1Electron {
  ...
  public:
   ...
   BaseU1Electron() { SetOnsiteOperator(); }
   ...
   explicit BaseU1Electron(const int total_electron) : BaseU1Electron() { SetTotalElectron(total_electron); }
   ...
   //! @param total_sz The total sz \f$ \langle\hat{S}^{z}_{\rm tot}\rangle=\sum^{N}_{i=1}\langle\hat{S}^{z}_{i}\rangle
   //! \f$.
   void SetTotalSz(const HalfInt total_sz) { total_sz_ = total_sz; }

   //! @brief Set the number of total electrons.
   //! @param total_electron The number of total electrons is represented by the expectation value of the following
   //! operator: \f[ \hat{N}_{\rm e}=\sum^{N}_{i=1}\hat{n}_{i} \f]
...
#pragma omp parallel num_threads(num_threads)
   ...
   static CRS CreateOnsiteOperatorCUpDagger() { return blas::CalculateTransposedMatrix(CreateOnsiteOperatorCUp()); }
   ...
   static CRS CreateOnsiteOperatorCDownDagger() { return blas::CalculateTransposedMatrix(CreateOnsiteOperatorCDown()); }
   ...
   static CRS CreateOnsiteOperatorNCUp() { return CreateOnsiteOperatorCUpDagger() * CreateOnsiteOperatorCUp(); }
   ...
   static CRS CreateOnsiteOperatorNCDown() { return CreateOnsiteOperatorCDownDagger() * CreateOnsiteOperatorCDown(); }
   ...
   static CRS CreateOnsiteOperatorNC() { return CreateOnsiteOperatorNCUp() + CreateOnsiteOperatorNCDown(); }
   ...
   static CRS CreateOnsiteOperatorSx() { return RealType{0.5} * (CreateOnsiteOperatorSp() + CreateOnsiteOperatorSm()); }
   ...
   static CRS CreateOnsiteOperatorSp() { return CreateOnsiteOperatorCUpDagger() * CreateOnsiteOperatorCDown(); }

   //! @brief Generate the lowering operator for spin of the electrons
   //! \f$ \hat{s}^{-}=\hat{c}^{\dagger}_{\downarrow}\hat{c}_{\uparrow}\f$.
   //! @return The matrix of \f$ \hat{s}^{-}\f$.
   static CRS CreateOnsiteOperatorSm() { return CreateOnsiteOperatorCDownDagger() * CreateOnsiteOperatorCUp(); }
