...
void SetEnergyDifference(std::vector<std::pair<typename model::PolynomialIsing<lattice::InfiniteRange, RealType>::OPType, RealType>> *sample_delta,
                         const model::PolynomialIsing<lattice::InfiniteRange, RealType> &model) {
   
   
   if (static_cast<std::int32_t>(sample_delta->size()) != model.GetSystemSize()) {
   ...
   for (std::int32_t index = 0; index < system_size; ++index) {
      RealType val = 0.0;
      const OPType target_spin = (*sample_delta)[index].first;
               ...
               for (std::int32_t i = start_index; i < system_size - 1; ++i) {
                  ...
                  if (size == p - 1) {
                     ...
                     for (std::int32_t j = 0; j < p - 1; ++j) {
                        if (indices[j] >= index) {
                           sign *= (*sample_delta)[indices[j] + 1].first;
                        }
                        else {
                           sign *= (*sample_delta)[indices[j]].first;
                        }
                     }
      ...
      (*sample_delta)[index].second = -2.0*val;
   }
...
template<typename RealType>
void UpdateConfiguration(std::vector<std::pair<typename model::PolynomialIsing<lattice::InfiniteRange, RealType>::OPType, RealType>> *sample_delta,
   ...
   if (degree == 3) {
      ...
      for (std::int32_t i2 = 0; i2 < system_size; ++i2) {
         ...
         const OPType spin_prod2 = spin_prod1*(*sample_delta)[i2].first;
         const RealType diff_val_i2 = 4*target_ineraction_deg2*spin_prod2;
         RealType sum_val_i2 = 0;
         for (std::int32_t i3 = i2 + 1; i3 < index; ++i3) {
            const RealType diff_val_i3 = 4*target_ineraction_deg3*spin_prod2*(*sample_delta)[i3].first;
            (*sample_delta)[i3].second += diff_val_i3;
         ...
         (*sample_delta)[i2].second += sum_val_i2 + diff_val_i2;
      }
   }
   else if (degree == 4) {
      const RealType target_ineraction_deg2 = interaction[2];
      ...
      for (std::int32_t i2 = 0; i2 < system_size; ++i2) {
         ...
         for (std::int32_t i3 = i2 + 1; i3 < system_size; ++i3) {
            ...
            const OPType spin_prod3 = spin_prod2*(*sample_delta)[i3].first;
            const RealType diff_val_i3 = 4*target_ineraction_deg3*spin_prod3;
            RealType sum_val_i3 = 0;
            for (std::int32_t i4 = i3 + 1; i4 < index; ++i4) {
               const RealType diff_val_i4 = 4*target_ineraction_deg4*spin_prod3*(*sample_delta)[i4].first;
               (*sample_delta)[i4].second += diff_val_i4;
            ...
            (*sample_delta)[i3].second += sum_val_i3 + diff_val_i3;
      ...
      for (std::int32_t i2 = 0; i2 < system_size; ++i2) {
         ...
         for (std::int32_t i3 = i2 + 1; i3 < system_size; ++i3) {
            ...
            for (std::int32_t i4 = i3 + 1; i4 < system_size; ++i4) {
               ...
               const OPType spin_prod4 = spin_prod3*(*sample_delta)[i4].first;
               const RealType diff_val_i4 = 4*target_ineraction_deg4*spin_prod4;
               RealType sum_val_i4 = 0;
               for (std::int32_t i5 = i4 + 1; i5 < index; ++i5) {
                  const RealType diff_val_i5 = 4*target_ineraction_deg5*spin_prod4*(*sample_delta)[i5].first;
                  (*sample_delta)[i5].second += diff_val_i5;
               ...
               (*sample_delta)[i4].second += sum_val_i4 + diff_val_i4;
         ...
         for (std::int32_t i3 = i2 + 1; i3 < system_size; ++i3) {
            ...
            for (std::int32_t i4 = i3 + 1; i4 < system_size; ++i4) {
               ...
               for (std::int32_t i5 = i4 + 1; i5 < system_size; ++i5) {
                  ...
                  const OPType spin_prod5 = spin_prod4*(*sample_delta)[i5].first;
                  const RealType diff_val_i5 = 4*target_ineraction_deg5*spin_prod5;
                  RealType sum_val_i5 = 0;
                  for (std::int32_t i6 = i5 + 1; i6 < index; ++i6) {
                     const RealType diff_val_i6 = 4*target_ineraction_deg6*spin_prod5*(*sample_delta)[i6].first;
                     (*sample_delta)[i6].second += diff_val_i6;
                  ...
                  (*sample_delta)[i5].second += sum_val_i5 + diff_val_i5;
            ...
            for (std::int32_t i4 = i3 + 1; i4 < system_size; ++i4) {
               ...
               for (std::int32_t i5 = i4 + 1; i5 < system_size; ++i5) {
                  ...
                  for (std::int32_t i6 = i5 + 1; i6 < system_size; ++i6) {
                     ...
                     const OPType spin_prod6 = spin_prod5*(*sample_delta)[i6].first;
                     const RealType diff_val_i6 = 4*target_ineraction_deg6*spin_prod6;
                     RealType sum_val_i6 = 0;
                     for (std::int32_t i7 = i6 + 1; i7 < index; ++i7) {
                        const RealType diff_val_i7 = 4*target_ineraction_deg7*spin_prod6*(*sample_delta)[i7].first;
                        (*sample_delta)[i7].second += diff_val_i7;
                     ...
                     (*sample_delta)[i6].second += sum_val_i6 + diff_val_i6;
   ...
   (*sample_delta)[index].first *= -1;
   (*sample_delta)[index].second *= -1;
