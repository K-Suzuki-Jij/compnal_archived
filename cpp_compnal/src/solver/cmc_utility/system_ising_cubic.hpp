...
class CMCSystem<model::Ising<lattice::Cubic, RealType>>: public CMCBaseIsingSystem {
...
template<typename RealType>
CMCSystem(const model::Ising<lattice::Cubic, RealType>) -> CMCSystem<model::Ising<lattice::Cubic, RealType>>;
