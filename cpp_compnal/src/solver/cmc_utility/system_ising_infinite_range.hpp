...
class CMCSystem<model::Ising<lattice::InfiniteRange, RealType>> {
...
template<typename RealType>
CMCSystem(const model::Ising<lattice::InfiniteRange, RealType>, const uint64_t) -> CMCSystem<model::Ising<lattice::InfiniteRange, RealType>>;
