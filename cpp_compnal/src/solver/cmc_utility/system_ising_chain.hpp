...
class CMCSystem<model::Ising<lattice::Chain, RealType>> {
...
template<typename RealType>
CMCSystem(const model::Ising<lattice::Chain, RealType>, const uint64_t) -> CMCSystem<model::Ising<lattice::Chain, RealType>>;
