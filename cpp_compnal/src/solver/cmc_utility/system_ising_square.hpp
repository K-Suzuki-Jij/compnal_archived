...
class CMCSystem<model::Ising<lattice::Square, RealType>> {
...
template<typename RealType>
CMCSystem(const model::Ising<lattice::Square, RealType>, const uint64_t) -> CMCSystem<model::Ising<lattice::Square, RealType>>;
