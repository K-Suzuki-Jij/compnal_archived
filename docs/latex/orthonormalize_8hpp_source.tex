...
\DoxyCodeLine{28 \textcolor{keywordtype}{void} \mbox{\hyperlink{namespacecompnal_1_1blas_ae30f924effa78f04d9e973b3525ed4b7}{Orthonormalize}}(std::vector<\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector}{type::BraketVector<RealType>}}> *vectors) \{}
...
\DoxyCodeLine{32          \textcolor{keyword}{const} RealType inner\_product = -\/1.0*\mbox{\hyperlink{namespacecompnal_1_1type_a31939adf3cd225e389a22c977793b46d}{CalculateInnerProduct}}(*vectors[i], (*vectors)[j]);}
...
\DoxyCodeLine{42 \textcolor{keywordtype}{void} \mbox{\hyperlink{namespacecompnal_1_1blas_ae30f924effa78f04d9e973b3525ed4b7}{Orthonormalize}}(\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector}{type::BraketVector<RealType>}} *target\_vector, \textcolor{keyword}{const} std::vector<\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector}{type::BraketVector<RealType>}}> \&vectors) \{}
\DoxyCodeLine{43    \textcolor{keyword}{const} std::int64\_t dim = \textcolor{keyword}{static\_cast<}std::int64\_t\textcolor{keyword}{>}(target\_vector-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}.size());}
\DoxyCodeLine{44    \textcolor{keywordflow}{for} (std::size\_t i = 0; i < vectors.size(); ++i) \{}
\DoxyCodeLine{45       \textcolor{keyword}{const} RealType inner\_product = -\/1.0*\mbox{\hyperlink{namespacecompnal_1_1type_a31939adf3cd225e389a22c977793b46d}{CalculateInnerProduct}}(*target\_vector, vectors[i]);}
...
\DoxyCodeLine{48          target\_vector-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}[j] += inner\_product*vectors[i].val[j];}
\DoxyCodeLine{49       \}}
\DoxyCodeLine{50    \}}
\DoxyCodeLine{51 \}}
\DoxyCodeLine{52 }
