...
\DoxyCodeLine{198    \}}
\DoxyCodeLine{199    }
\DoxyCodeLine{200    \textcolor{keywordtype}{void} \mbox{\hyperlink{structcompnal_1_1sparse__matrix_1_1_c_r_s_a4bec11205690c0b77b91e262356d49e7}{PrintMatrix}}(\textcolor{keyword}{const} std::string display\_name = \textcolor{stringliteral}{"{}Matrix"{}})\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{564 }
\DoxyCodeLine{565 }
\DoxyCodeLine{566 \} \textcolor{comment}{// namespace sparse\_matrix}}
\DoxyCodeLine{567 \} \textcolor{comment}{// namespace compnal}}
\DoxyCodeLine{568 }
\DoxyCodeLine{569 }
\DoxyCodeLine{570 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* COMPNAL\_SPARSE\_MATRIX\_COMPRESSED\_ROW\_STORAGE\_HPP\_ */}\textcolor{preprocessor}{}}
