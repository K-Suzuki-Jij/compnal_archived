...
\DoxyCodeLine{69 }
\DoxyCodeLine{70 }
\DoxyCodeLine{71 \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} \mbox{\hyperlink{namespacecompnal_1_1utility_a11fe827a2e8d4c8794e29be3e130560c}{CalculateBinomialCoefficient}}(\textcolor{keywordtype}{int} n, \textcolor{keyword}{const} \textcolor{keywordtype}{int} k) \{}
...
\DoxyCodeLine{76    \}}
\DoxyCodeLine{77    }
\DoxyCodeLine{78    \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} r = 1;}
\DoxyCodeLine{79    }
...
\DoxyCodeLine{87 \}}
\DoxyCodeLine{88 }
\DoxyCodeLine{89 std::vector<std::vector<LInt>> \mbox{\hyperlink{namespacecompnal_1_1utility_ab4bbef4ed33eaa05489524e9f226e901}{CalculateBinomialTable}}(\textcolor{keywordtype}{int} N) \{}
\DoxyCodeLine{90    std::vector<std::vector<LInt>> vec(N + 1, std::vector<LInt>(N + 1));}
...
\DoxyCodeLine{102 \}}
\DoxyCodeLine{103 }
\DoxyCodeLine{104 \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} \mbox{\hyperlink{namespacecompnal_1_1utility_a994046cacd6facdee7cfde9aa3b9626c}{CalculateNumCombination}}(\textcolor{keyword}{const} std::vector<int> \&list) \{}
\DoxyCodeLine{105    }
...
\DoxyCodeLine{110    \}}
\DoxyCodeLine{111    }
\DoxyCodeLine{112    \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} result = 1;}
...
\DoxyCodeLine{116       result *= \mbox{\hyperlink{namespacecompnal_1_1utility_a11fe827a2e8d4c8794e29be3e130560c}{CalculateBinomialCoefficient}}(size\_list, it.second);}
...
\DoxyCodeLine{122 \}}
\DoxyCodeLine{123 }
\DoxyCodeLine{124 \textcolor{keywordtype}{void} \mbox{\hyperlink{namespacecompnal_1_1utility_ad87f45a3383a5b141b1804d8e8ec558d}{CalculateNthPermutation}}(std::vector<int> *vec, \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} target\_num) \{}
\DoxyCodeLine{125    }
...
\DoxyCodeLine{135       \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} temp1 = 0;}
...
\DoxyCodeLine{139             \mbox{\hyperlink{namespacecompnal_a5c65468895022d33488c22744a8c46fc}{LInt}} temp2 = 1;}
...
\DoxyCodeLine{142                temp2 *= \mbox{\hyperlink{namespacecompnal_1_1utility_a11fe827a2e8d4c8794e29be3e130560c}{CalculateBinomialCoefficient}}(size, it2.second);}
...
\DoxyCodeLine{159       ss << \textcolor{stringliteral}{"{}Error in "{}} << \_\_FUNCTION\_\_ << std::endl;}
...
\DoxyCodeLine{168 \}}
\DoxyCodeLine{169 }
\DoxyCodeLine{170 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* COMPNAL\_UTILITY\_INTEGER\_HPP\_ */}\textcolor{preprocessor}{}}
