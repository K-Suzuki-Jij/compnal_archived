...
\DoxyCodeLine{998       }
\DoxyCodeLine{999       \textcolor{keyword}{const} \textcolor{keyword}{auto} \&nc            = model\_input.GetOnsiteOperatorNC();}
\DoxyCodeLine{1000       \textcolor{keyword}{const} \textcolor{keyword}{auto} \&c\_up          = model\_input.GetOnsiteOperatorCUp();}
\DoxyCodeLine{1001       \textcolor{keyword}{const} \textcolor{keyword}{auto} \&c\_up\_dagger   = model\_input.GetOnsiteOperatorCUpDagger();}
\DoxyCodeLine{1002       \textcolor{keyword}{const} \textcolor{keyword}{auto} \&c\_down        = model\_input.GetOnsiteOperatorCDown();}
\DoxyCodeLine{1003       \textcolor{keyword}{const} \textcolor{keyword}{auto} \&c\_down\_dagger = model\_input.GetOnsiteOperatorCDownDagger();}
\DoxyCodeLine{1004       }
\DoxyCodeLine{1005       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} site = 0; site < model\_input.GetSystemSize(); ++site) \{}
\DoxyCodeLine{1006          edmc-\/>\mbox{\hyperlink{structcompnal_1_1solver_1_1_exact_diag_matrix_components_a7329695bd8377ce171a1774a1ecb36a9}{basis\_onsite}}[site] = \mbox{\hyperlink{classcompnal_1_1solver_1_1_exact_diag_a1a3a0400cf96ee595d5a095cfb1c4f87}{CalculateLocalBasis}}(basis, site, model\_input.GetDimOnsite());}
\DoxyCodeLine{1007       \}}
\DoxyCodeLine{1008       }
\DoxyCodeLine{1009       \textcolor{comment}{//Onsite elements}}
\DoxyCodeLine{1010       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} site = 0; site < model\_input.GetSystemSize(); ++site) \{}
...
\DoxyCodeLine{1016          \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} site = 0; site < model\_input.GetSystemSize() -\/ distance; ++site) \{}
...
\DoxyCodeLine{1023          \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} site = 0; site < model\_input.GetSystemSize() -\/ distance; ++site) \{}
...
\DoxyCodeLine{1027                n\_electron += model\_input.CalculateNumElectron(edmc-\/>\mbox{\hyperlink{structcompnal_1_1solver_1_1_exact_diag_matrix_components_a7329695bd8377ce171a1774a1ecb36a9}{basis\_onsite}}[s]);}
\DoxyCodeLine{1028             \}}
...
\DoxyCodeLine{1040                \textcolor{keyword}{const} \textcolor{keyword}{auto} d1 = model\_input.GetSystemSize() -\/ distance + i;}
...
\DoxyCodeLine{1049                \textcolor{keyword}{const} \textcolor{keyword}{auto} d1 = model\_input.GetSystemSize() -\/ distance + i;}
...
\DoxyCodeLine{1054                   n\_electron += model\_input.CalculateNumElectron(edmc-\/>\mbox{\hyperlink{structcompnal_1_1solver_1_1_exact_diag_matrix_components_a7329695bd8377ce171a1774a1ecb36a9}{basis\_onsite}}[s]);}
\DoxyCodeLine{1055                \}}
