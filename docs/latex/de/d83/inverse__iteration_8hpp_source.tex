...
\DoxyCodeLine{49       \textcolor{keywordflow}{if} (\textcolor{keyword}{static\_cast<}std::int64\_t\textcolor{keyword}{>}(eigenvector-\/>val.size()) != matrix\_in-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a10b5bb820d0d37d577a0696bd5b62040}{row\_dim}}) \{}
...
\DoxyCodeLine{66       \}}
\DoxyCodeLine{67       \textcolor{keyword}{const} RealType residual\_error = \mbox{\hyperlink{namespacecompnal_1_1type_a49a46e2c0dff11c5ef25b7d1325d64e0}{CalculateL1Norm}}(params.diag\_add, *eigenvector, 1.0, vectors\_work);}
\DoxyCodeLine{68       }
