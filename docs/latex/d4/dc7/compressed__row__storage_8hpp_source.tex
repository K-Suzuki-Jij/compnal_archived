...
\DoxyCodeLine{354 \textcolor{keywordtype}{bool} \mbox{\hyperlink{namespacecompnal_1_1type_abb6429171e978e71a1fbd6682875ca56}{operator==}}(\textcolor{keyword}{const} \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS<T1>}} \&lhs, \textcolor{keyword}{const} \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS<T2>}} \&rhs) \{}
...
\DoxyCodeLine{409 std::ostream\& \mbox{\hyperlink{namespacecompnal_1_1type_ab565f905bc0e0a4cdea7cbee1b5c0da1}{operator<<}}(std::ostream \&os, \textcolor{keyword}{const} \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS<ValueType>}} \&m) \{}
...
\DoxyCodeLine{633    \}}
\DoxyCodeLine{634    }
\DoxyCodeLine{635    \textcolor{keywordflow}{if} (matrix\_1.tag == \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11ba861b16b31f1b6b1c04552516e7a85987}{CRSTag::NONE}}) \{}
\DoxyCodeLine{636       matrix\_out.tag = matrix\_2.tag;}
\DoxyCodeLine{637    \}}
\DoxyCodeLine{638    \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (matrix\_1.tag == \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11baf96aeb914af342db32480b224f95bd6f}{CRSTag::FERMION}}) \{}
\DoxyCodeLine{639       \textcolor{keywordflow}{if} (matrix\_2.tag == \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11ba861b16b31f1b6b1c04552516e7a85987}{CRSTag::NONE}} || matrix\_2.tag == \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11baf96aeb914af342db32480b224f95bd6f}{CRSTag::FERMION}}) \{}
\DoxyCodeLine{640          matrix\_out.tag = \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11baf96aeb914af342db32480b224f95bd6f}{CRSTag::FERMION}};}
\DoxyCodeLine{641       \}}
\DoxyCodeLine{642       \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (matrix\_2.tag == \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11bad14dac1fb07c963ddc13357a8b1a94de}{CRSTag::BOSON}} || matrix\_2.tag == \mbox{\hyperlink{namespacecompnal_1_1type_aa249dd69b73057aa6d2d501c0825e11baac3550dd78df756a2b31dfbab46f2647}{CRSTag::MIX}}) \{}
\DoxyCodeLine{643          }
\DoxyCodeLine{644       \}}
\DoxyCodeLine{645       \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{646          std::stringstream ss;}
\DoxyCodeLine{647          ss << \textcolor{stringliteral}{"{}Error at "{}} << \_\_LINE\_\_ << \textcolor{stringliteral}{"{} in "{}} << \_\_func\_\_ << \textcolor{stringliteral}{"{} in "{}}<< \_\_FILE\_\_ << std::endl;}
\DoxyCodeLine{648          ss << \textcolor{stringliteral}{"{}Unknown CRSTag detected."{}};}
\DoxyCodeLine{649          \textcolor{keywordflow}{throw} std::runtime\_error(ss.str());}
\DoxyCodeLine{650       \}}
\DoxyCodeLine{651    \}}
\DoxyCodeLine{652    matrix\_out.tag = matrix\_1.tag;}
\DoxyCodeLine{653    \textcolor{keywordflow}{return} matrix\_out;}
\DoxyCodeLine{654 \}}
\DoxyCodeLine{655 }
\DoxyCodeLine{656 \textcolor{keyword}{template}<\textcolor{keyword}{typename} T1, \textcolor{keyword}{typename} T2>}
\DoxyCodeLine{657 \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS}}<\textcolor{keyword}{decltype}(T1\{0\}*T2\{0\})> \mbox{\hyperlink{namespacecompnal_1_1type_a3d20246b76133046a66537e761e8b5cc}{CalculateScalarMatrixProduct}}(\textcolor{keyword}{const} T1 lhs, \textcolor{keyword}{const} CRS<T2> \&rhs) \{}
\DoxyCodeLine{658    }
\DoxyCodeLine{659    CRS<\textcolor{keyword}{decltype}(T1\{0\}*T2\{0\})> out(rhs.row\_dim, rhs.col\_dim, rhs.tag);}
\DoxyCodeLine{660    out.col.resize(rhs.col.size());}
\DoxyCodeLine{661    out.val.resize(rhs.val.size());}
\DoxyCodeLine{662    }
\DoxyCodeLine{663 \textcolor{preprocessor}{\#pragma omp parallel for}}
\DoxyCodeLine{664    \textcolor{keywordflow}{for} (std::size\_t i = 0; i < rhs.col.size(); ++i) \{}
\DoxyCodeLine{665       out.col[i] = rhs.col[i];}
\DoxyCodeLine{666       out.val[i] = lhs*rhs.val[i];}
\DoxyCodeLine{667    \}}
\DoxyCodeLine{668    }
\DoxyCodeLine{669 \textcolor{preprocessor}{\#pragma omp parallel for}}
\DoxyCodeLine{670    \textcolor{keywordflow}{for} (std::int64\_t i = 1; i <= rhs.row\_dim; ++i) \{}
\DoxyCodeLine{671       out.row[i] = rhs.row[i];}
\DoxyCodeLine{672    \}}
\DoxyCodeLine{673    \textcolor{keywordflow}{return} out;}
\DoxyCodeLine{674 \}}
\DoxyCodeLine{675 }
\DoxyCodeLine{676 \textcolor{keyword}{template}<\textcolor{keyword}{typename} ValueType>}
\DoxyCodeLine{677 \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS<ValueType>}} \mbox{\hyperlink{namespacecompnal_1_1type_a5346fac9bf3b703982976a27f440168b}{CalculateTransposedMatrix}}(\textcolor{keyword}{const} \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS<ValueType>}} \&matrix\_in) \{}
\DoxyCodeLine{678 }
\DoxyCodeLine{679    \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{CRS<ValueType>}} matrix\_out(matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a9a125a4c12ea266d0a72e8744a513903}{col\_dim}}, matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a10b5bb820d0d37d577a0696bd5b62040}{row\_dim}}, matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_aacfa2feb99e5970d2a2d0a07b2528577}{tag}});}
\DoxyCodeLine{680    }
\DoxyCodeLine{681    std::vector<std::int64\_t> row\_count(matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a10b5bb820d0d37d577a0696bd5b62040}{row\_dim}});}
\DoxyCodeLine{682    \textcolor{keywordflow}{for} (std::int64\_t i = 0; i < matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a9a125a4c12ea266d0a72e8744a513903}{col\_dim}}; ++i) \{}
\DoxyCodeLine{683       \textcolor{keywordflow}{for} (std::int64\_t j = 0; j < matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a10b5bb820d0d37d577a0696bd5b62040}{row\_dim}}; ++j) \{}
\DoxyCodeLine{684          \textcolor{keyword}{const} std::int64\_t row = matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a88ad5393f23fb80095433cf1e0e08e95}{row}}[j] + row\_count[j];}
\DoxyCodeLine{685          \textcolor{keywordflow}{if} (row < matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a88ad5393f23fb80095433cf1e0e08e95}{row}}[j + 1] \&\& matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a06588e369b2a6cd56586ec3f50735950}{col}}[row] == i) \{}
\DoxyCodeLine{686             matrix\_out.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_aa03a45f3e001a06d1df4b8362a0464eb}{val}}.push\_back(matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_aa03a45f3e001a06d1df4b8362a0464eb}{val}}[row]);}
\DoxyCodeLine{687             matrix\_out.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a06588e369b2a6cd56586ec3f50735950}{col}}.push\_back(j);}
\DoxyCodeLine{688             row\_count[j]++;}
\DoxyCodeLine{689          \}}
\DoxyCodeLine{690       \}}
\DoxyCodeLine{691       matrix\_out.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a88ad5393f23fb80095433cf1e0e08e95}{row}}[i + 1] = matrix\_out.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a06588e369b2a6cd56586ec3f50735950}{col}}.size();}
\DoxyCodeLine{692    \}}
\DoxyCodeLine{693    }
\DoxyCodeLine{694    \textcolor{keywordflow}{return} matrix\_out;}
\DoxyCodeLine{695 \}}
\DoxyCodeLine{696 }
\DoxyCodeLine{697 \} \textcolor{comment}{// namespace type}}
\DoxyCodeLine{698 \} \textcolor{comment}{// namespace compnal}}
\DoxyCodeLine{699 }
\DoxyCodeLine{700 }
\DoxyCodeLine{701 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* COMPNAL\_TYPE\_COMPRESSED\_ROW\_STORAGE\_HPP\_ */}\textcolor{preprocessor}{}}
