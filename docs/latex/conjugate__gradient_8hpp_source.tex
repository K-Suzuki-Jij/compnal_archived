...
\DoxyCodeLine{35 std::pair<int, double> \mbox{\hyperlink{namespacecompnal_1_1blas_aada41a4581ddc0dc68722f8c5dc3ae5e}{ConjugateGradient}}(\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector}{type::BraketVector<RealType>}} *vec\_out,}
\DoxyCodeLine{36                                          \textcolor{keyword}{const} \mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s}{type::CRS<RealType>}}    \&matrix\_in,}
\DoxyCodeLine{37                                          \textcolor{keyword}{const} \mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector}{type::BraketVector<RealType>}} \&vec\_in,}
...
\DoxyCodeLine{39                                          \textcolor{keyword}{const} std::vector<\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector}{type::BraketVector<RealType>}}> \&subspace\_vectors = \{\}}
\DoxyCodeLine{40                                          ) \{}
\DoxyCodeLine{41    }
...
\DoxyCodeLine{48    \}}
\DoxyCodeLine{49    }
\DoxyCodeLine{50    \textcolor{keywordflow}{if} (\textcolor{keyword}{static\_cast<}std::int64\_t\textcolor{keyword}{>}(vec\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}.size()) != matrix\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_c_r_s_a10b5bb820d0d37d577a0696bd5b62040}{row\_dim}}) \{}
...
\DoxyCodeLine{71       \textcolor{keywordflow}{if} (\textcolor{keyword}{static\_cast<}std::int64\_t\textcolor{keyword}{>}(vec\_out-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}.size()) != dim) \{}
...
\DoxyCodeLine{82       vec\_out-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}.resize(dim);}
\DoxyCodeLine{83       \textcolor{keywordflow}{for} (std::int64\_t i = 0; i < dim; ++i) \{}
\DoxyCodeLine{84          vec\_out-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}[i] = uniform\_rand(random\_number\_engine);}
\DoxyCodeLine{85       \}}
\DoxyCodeLine{86    \}}
...
\DoxyCodeLine{88    vec\_out-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_a44a1b92b698487487b53f400c8e0a1e4}{Normalize}}();}
...
\DoxyCodeLine{98       rrr.val[i] = vec\_in.\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}[i] -\/ rrr.val[i];}
...
\DoxyCodeLine{114       }
\DoxyCodeLine{115       \textcolor{keyword}{const} RealType inner\_prod = \mbox{\hyperlink{namespacecompnal_1_1type_a31939adf3cd225e389a22c977793b46d}{CalculateInnerProduct}}(rrr, rrr);}
\DoxyCodeLine{116       \textcolor{keyword}{const} RealType alpha      = inner\_prod/\mbox{\hyperlink{namespacecompnal_1_1type_a31939adf3cd225e389a22c977793b46d}{CalculateInnerProduct}}(ppp, yyy);}
\DoxyCodeLine{117       }
...
\DoxyCodeLine{120          vec\_out-\/>\mbox{\hyperlink{structcompnal_1_1type_1_1_braket_vector_aab4cd0a18c00793ee84a2f5b77f81c9e}{val}}[i] += alpha*ppp.val[i];}
...
\DoxyCodeLine{126       }
\DoxyCodeLine{127       \textcolor{keyword}{const} RealType residual\_error = \mbox{\hyperlink{namespacecompnal_1_1type_a31939adf3cd225e389a22c977793b46d}{CalculateInnerProduct}}(rrr, rrr);}
\DoxyCodeLine{128       }
