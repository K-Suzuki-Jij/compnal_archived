...
void UpdaterInfiniteRange(std::vector<SpinType> *sample,
   ...
   if (interaction.size() == 2) {
      ...
      for (int i2 = 0; i2 < num_roop; ++i2) {
         ...
         (*energy_difference)[index_i2] += 4*target_ineraction_deg2*spin_prod2;
         for (int i3 = i2 + 1; i3 < num_roop; ++i3) {
            ...
            sum_val_i3 += diff_val_i3;
            (*energy_difference)[index_i3] += diff_val_i3;
         }
         (*energy_difference)[index_i2] += sum_val_i3;
      }
   }
      ...
      for (int i2 = 0; i2 < num_roop; ++i2) {
         ...
         for (int i3 = i2 + 1; i3 < num_roop; ++i3) {
            ...
            sum_val_i2 += sum_val_i3;
            (*energy_difference)[index_i3] += sum_val_i3;
         }
         (*energy_difference)[index_i2] += sum_val_i2;
      }
   }
      ...
      for (int i2 = 0; i2 < num_roop; ++i2) {
         ...
         for (int i3 = i2 + 1; i3 < num_roop; ++i3) {
            ...
            for (int i4 = i3 + 1; i4 < num_roop; ++i4) {
               ...
               sum_val_i3 += sum_val_i4;
               (*energy_difference)[index_i4] += sum_val_i4;
            }
            sum_val_i2 += sum_val_i3;
            (*energy_difference)[index_i3] += sum_val_i3;
         }
      ...
      for (int i2 = 0; i2 < num_roop; ++i2) {
         ...
         for (int i3 = i2 + 1; i3 < num_roop; ++i3) {
            const int index_i3 = (*system_size_index_list)[i3];
            const SpinType spin_prod3 = spin_prod2*(*sample)[index_i3];
            (*energy_difference)[index_i2] += 4*target_ineraction_deg3*spin_prod3;
            (*energy_difference)[index_i3] += 4*target_ineraction_deg3*spin_prod3;
            for (int i4 = i3 + 1; i4 < num_roop; ++i4) {
               const int index_i4 = (*system_size_index_list)[i4];
               const SpinType spin_prod4 = spin_prod3*(*sample)[index_i4];
               (*energy_difference)[index_i2] += 4*target_ineraction_deg4*spin_prod4;
               (*energy_difference)[index_i3] += 4*target_ineraction_deg4*spin_prod4;
               (*energy_difference)[index_i4] += 4*target_ineraction_deg4*spin_prod4;
               for (int i5 = i4 + 1; i5 < num_roop; ++i5) {
                  const int index_i5 = (*system_size_index_list)[i5];
                  const SpinType spin_prod5 = spin_prod4*(*sample)[index_i5];
                  (*energy_difference)[index_i2] += 4*target_ineraction_deg5*spin_prod5;
                  (*energy_difference)[index_i3] += 4*target_ineraction_deg5*spin_prod5;
                  (*energy_difference)[index_i4] += 4*target_ineraction_deg5*spin_prod5;
                  (*energy_difference)[index_i5] += 4*target_ineraction_deg5*spin_prod5;
                  for (int i6 = i5 + 1; i6 < num_roop; ++i6) {
                     const int index_i6 = (*system_size_index_list)[i6];
                     (*energy_difference)[index_i2] += 4*target_ineraction_deg6*spin_prod5*(*sample)[index_i6];
                     (*energy_difference)[index_i3] += 4*target_ineraction_deg6*spin_prod5*(*sample)[index_i6];
                     (*energy_difference)[index_i4] += 4*target_ineraction_deg6*spin_prod5*(*sample)[index_i6];
                     (*energy_difference)[index_i5] += 4*target_ineraction_deg6*spin_prod5*(*sample)[index_i6];
                     (*energy_difference)[index_i6] += 4*target_ineraction_deg6*spin_prod5*(*sample)[index_i6];
                  }
               }
            }
         }
            ...
            for (int i4 = i3 + 1; i4 < num_roop; ++i4) {
               ...
               for (int i5 = i4 + 1; i5 < num_roop; ++i5) {
                  ...
                  for (int i6 = i5 + 1; i6 < num_roop; ++i6) {
                     ...
                     (*energy_difference)[index_i2] += 4*target_ineraction_deg6*spin_prod6;
                     (*energy_difference)[index_i3] += 4*target_ineraction_deg6*spin_prod6;
                     (*energy_difference)[index_i4] += 4*target_ineraction_deg6*spin_prod6;
                     (*energy_difference)[index_i5] += 4*target_ineraction_deg6*spin_prod6;
                     (*energy_difference)[index_i6] += 4*target_ineraction_deg6*spin_prod6;
                     for (int i7 = i6 + 1; i7 < num_roop; ++i7) {
                        const int index_i7 = (*system_size_index_list)[i7];
                        (*energy_difference)[index_i2] += 4*target_ineraction_deg7*spin_prod6*(*sample)[index_i7];
                        (*energy_difference)[index_i3] += 4*target_ineraction_deg7*spin_prod6*(*sample)[index_i7];
                        (*energy_difference)[index_i4] += 4*target_ineraction_deg7*spin_prod6*(*sample)[index_i7];
                        (*energy_difference)[index_i5] += 4*target_ineraction_deg7*spin_prod6*(*sample)[index_i7];
                        (*energy_difference)[index_i6] += 4*target_ineraction_deg7*spin_prod6*(*sample)[index_i7];
                        (*energy_difference)[index_i7] += 4*target_ineraction_deg7*spin_prod6*(*sample)[index_i7];
                     }
                  }
               }
            }
